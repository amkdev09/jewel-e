  ...
  <ul className="m-0 pt-[8px] pr-[16px] pb-[16px] pl-[16px] list-none overflow-x-auto whitespace-nowrap bg-white scrollbar-hide md:hidden">
    {CATEGORY_ITEMS.map(({ label, image, to }) => (
      <li key={label}
        ...
        <div
          className="mb-[7px] pt-[100%] relative rounded-[20px]"
        >
          <img
            src={image}
            alt={label}
...
const Hero = () => (
  <section
    className="flex items-center my-4 md:my-8 rounded-[12px] flex-col gap-4 md:gap-[24px] h-[280px] sm:h-[360px] md:h-[720px]"
  >
    <div className="relative w-full h-full flex items-center pl-4 md:pl-[40px] pr-4 rounded-[inherit]">
      ...
      <div className="relative z-10 max-w-[560px]">
        <p className="text-white text-sm md:text-2xl" style={{ lineHeight: 1.3, marginBottom: "8px" }}>
          SHOP STUNNING DESIGNS WITH
        </p>
        <p className="font-bold text-2xl sm:text-4xl md:text-[72px]" style={{ lineHeight: 1.1, color: "#FFE082", marginBottom: "8px", letterSpacing: "-0.02em" }}>
          EXTRA ₹500/GM
        </p>
        <p className="text-white text-xs md:text-lg" style={{ lineHeight: 1.4 }}>
...
const ProductCard = ({ name, price, image }) => (
  <div className="flex flex-col rounded-[6px] overflow-hidden w-full max-w-[260px] md:max-w-none md:w-[260px]" >
    ...
    <div className="p-2 md:p-4 w-full md:w-[260px] rounded-md">
      <div className="flex items-center gap-2">
        <span className="text-[#4E0756] font-semibold text-sm md:text-lg">
          {price}
        </span>
...
const TrendingSection = () => (
  <section className="flex flex-col md:flex-row gap-0 mx-0 md:mx-8.75 rounded-[12px] overflow-hidden min-h-[420px] md:h-[380px] shadow-lg" style={{ marginTop: "20px" }}>
    <div
    ...
    >
      <p className="text-white relative z-10 text-base md:text-[22px]" style={{ marginBottom: "8px" }}>TRENDING DESIGNS</p>
      <p className="text-white font-bold relative z-10 text-2xl md:text-[36px]" style={{ marginBottom: "20px", lineHeight: 1.2 }}>GET UPTO 40% OFF</p>
      <div className="relative z-10"><BtnPrimary className="text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary></div>
    ...
    <div className="py-4 md:py-[50px] pl-4 md:pl-[40px] pr-4 md:pr-[40px] relative overflow-x-auto"
      style={{ background: "linear-gradient(180deg, #CFC1FF 0%, #FFFFFF 100%)", width: "100%" }}>
...
const GuayaSection = () => (
  <section className="flex flex-col md:flex-row gap-4 rounded-[12px] overflow-hidden min-h-0 md:h-[880px] shadow-lg mt-5 md:mt-[30px]">
    <div
      className="relative flex items-end justify-start overflow-hidden rounded-[12px] flex-1 min-h-[220px] md:min-h-0"
    >
      ...
      <div className="relative z-10 pl-5 md:pl-[50px] pb-5 md:pb-[50px]">
        <p className="text-white font-normal text-4xl md:text-[70px]" style={{ lineHeight: 1.1, fontFamily: "Great Vibes, cursive" }}>GUAYA</p>
        <p className="text-white text-2xl md:text-[36px]" style={{ fontFamily: "Great Vibes, cursive" }}>Gulabo</p>
      </div>
    </div>
    <div className="flex-1 flex flex-col gap-4 min-h-0">
      <div className="relative flex flex-col justify-center items-start pl-5 md:pl-[40px] py-6 md:py-0 overflow-hidden rounded-[12px] flex-1 min-h-[140px] md:min-h-0" style={{ backgroundColor: "#7EB5C6" }}>
        <img src={ring} alt="" className="absolute right-0 bottom-0 w-32 md:w-48 h-full object-cover object-right opacity-80 hidden md:block" />
        <p className="text-white font-semibold relative z-10 text-2xl md:text-[44px]" style={{ letterSpacing: "0.02em" }}>LATEST</p>
        <p className="text-white relative z-10 text-sm md:text-[20px]" style={{ marginBottom: "16px" }}>DESIGNS</p>
        <BtnPrimary className="relative z-10 text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary>
      </div>
      <div className="relative flex flex-col justify-center items-start pl-5 md:pl-[40px] py-6 md:py-0 overflow-hidden rounded-[12px] flex-1 min-h-[140px] md:min-h-0" style={{ backgroundColor: "#2C2C2C" }}>
        <img src={ring} alt="" className="absolute right-0 bottom-0 w-32 md:w-48 h-full object-cover object-right opacity-70 hidden md:block" />
        <p className="text-white relative z-10 text-sm md:text-[22px]" style={{ marginBottom: "4px" }}>In Season,</p>
        <p className="text-white font-semibold relative z-10 text-2xl md:text-[36px]" style={{ letterSpacing: "0.02em" }}>PEARL</p>
        <BtnPrimary className="relative z-10 mt-2 text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary>
      </div>
    </div>
  </section>
);
...
const CategoryRow = () => (
  ...
  >
    <div className="flex gap-3 md:gap-5 items-center justify-center flex-col flex-shrink-0 w-[120px] md:w-[20%]">
      <GiftIcon />
      <p
        className="text-center py-2 md:py-3 px-1 md:px-2 text-[#4F3267] font-medium leading-snug min-h-[44px] flex items-center justify-center text-[10px] md:text-xs"
      >
        Wrapped with love
      </p>
    </div>
    {CATEGORY_CARDS.map(({ label, icon, image }) => (
      ...
      >
        ...
        <p
          className="flex-1 text-center py-2 md:py-4 px-2 md:px-3 text-[#4F3267] font-semibold text-xs md:text-base uppercase tracking-wide leading-snug flex items-center justify-center"
        >
          {label}
        </p>
      </a>
...
const GiftEmeraldSection = () => (
  <section className="flex flex-col md:flex-row gap-4 md:gap-5 min-h-0 md:min-h-[860px] mt-5 md:mt-0">
    <div className="flex flex-col justify-center pl-5 md:pl-[50px] pr-5 md:pr-[40px] py-8 md:py-0 relative overflow-hidden w-full md:w-[50%] bg-[#4E0756] rounded-[12px] min-h-[200px] md:min-h-0">
      ...
      <p className="text-white text-lg md:text-[22px]" style={{ marginBottom: "8px" }}>GIFT A THOUSAND SMILES</p>
      <p className="text-white opacity-90 text-xs md:text-sm" style={{ lineHeight: 1.5, marginBottom: "20px", maxWidth: "320px" }}>
        Explore our gifting collection for every occasion.
      </p>
      <BtnPrimary className="text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary>
    </div>
    <div className="flex flex-col gap-4 md:gap-5 w-full md:w-[50%]">
      <div className="relative flex-1 flex flex-col justify-center items-start pl-5 md:pl-[40px] py-6 md:py-0 overflow-hidden bg-[#214D3C] rounded-[12px] min-h-[140px] md:min-h-0">
        <p className="text-white font-semibold text-2xl md:text-[40px]" style={{ letterSpacing: "0.02em" }}>EMERALD</p>
        <BtnPrimary className="mt-2 text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary>
      </div>
      <div className="relative flex-1 flex flex-col justify-center items-start pl-5 md:pl-[40px] py-6 md:py-0 bg-[#F5F0F8] rounded-[12px] min-h-[140px] md:min-h-0">
        <p className="text-[#1F1F1F] font-semibold text-xl md:text-[28px]" style={{ letterSpacing: "0.02em" }}>Prebook Gold.</p>
        <BtnPrimary className="mt-2 text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary>
      </div>
    </div>
  </section>
...
const BestSellersSection = () => (
  <section className="bg-white pt-6 md:pt-10.5 css-1w2m1a2 -mx-5 mt-6 md:mt-8">
    <h2 className="font-inter-semibold text-center text-[var(--primary-color-a)] pb-6 md:pb-10.5 text-xl md:text-3xl">CaratLane Collections</h2>
    <div className="px-4 md:px-5">
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-5">
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="aspect-[4/4] bg-[#F5F0F8] rounded-[12px]" style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.05)" }}>
            <img src={ring} alt="" className="w-full h-full object-cover" />
          </div>
        ))}
      </div>
      <div className="flex justify-center mt-6 md:mt-11.5">
        <BtnPrimary className="px-6 md:px-28 text-xs md:text-sm py-3 md:py-4">VIEW ALL COLLECTIONS</BtnPrimary>
      </div>
    </div>
  </section>
);
  ...
  <section className="flex flex-col gap-4 md:gap-5 my-6 md:my-10.5">
    <div className="flex flex-col md:flex-row items-stretch gap-3 md:gap-2">
      {[
        ...
        >
          <img src={item.img} alt="" className="absolute right-0 bottom-0 w-1/2 h-full object-cover object-right opacity-80 hidden md:block" />
          <p className={`relative z-10 font-semibold text-base md:text-[22px] ${item.textDark ? "text-[#1F1F1F]" : "text-white"}`} style={{ marginBottom: "16px" }}>{item.title}</p>
          <BtnPrimary className="relative z-10 text-xs md:text-sm py-3 md:py-4 px-8 md:px-16">SHOP NOW</BtnPrimary>
        </div>
      ))}
    </div>
          ...
          >
            <div className="h-full px-5 md:px-8 py-4 md:py-6 flex flex-col justify-between">
              <div>
                ...
                <h3 className="mt-2 font-semibold text-base md:text-[22px]" style={{ lineHeight: 1.3 }}>
                  {item.title}
                </h3>
                {item.subtitle && (
    ...
    <div className="max-h-none md:max-h-[860px]">
      <div className="flex flex-col md:flex-row gap-0">
        ...
        <div className="flex-1 flex flex-col justify-center bg-[#F8EFEA] rounded-b-[12px] md:rounded-[0_12px_12px_0] p-6 md:p-10">
          <h3 className="text-center font-medium text-[#3d3d3d] mb-4 md:mb-6 text-sm md:text-[18px]" style={{ lineHeight: 1.4 }}>
      ...
      {[
        ...
        >
          ...
          <div className="relative z-10 p-4 md:p-6 pt-12 md:pt-16">
            <h3 className="text-white font-semibold mb-3 md:mb-4 text-base md:text-[20px]" style={{ lineHeight: 1.3 }}>
              {item.title}
            </h3>
            <button
              type="button"
    ...
    <div className="w-full rounded-[18px] bg-[#EDEBFF] py-6 md:py-8 px-4 md:px-10">
      <div className="flex md:flex-wrap justify-start md:justify-center gap-4 md:gap-8 overflow-x-auto scrollbar-hide pb-2 md:pb-0">
        {[
          ...
          <div key={i} className="flex flex-col items-center flex-shrink-0 w-[140px] md:w-auto md:min-w-[180px]">
            <div className="relative w-[140px] h-[110px] md:w-[190px] md:h-[150px] flex items-center justify-center">
              ...
              <div className="absolute inset-x-0 top-0 mx-auto w-[130px] h-[100px] md:w-[180px] md:h-[126px] rounded-[18px] bg-white shadow-sm flex items-center justify-center overflow-hidden">
                <img src={ring} alt={item.title} className="max-w-[100px] max-h-[70px] md:max-w-[140px] md:max-h-[95px] object-contain" />
              </div>
            </div>
  ...
  >
    <div className="max-w-[1200px] mx-auto rounded-[16px] md:rounded-[24px] overflow-hidden relative bg-[#100020]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 md:px-6 py-4">
        <p
          className="text-white/80 mb-2 md:mb-3 font-inter-semibold text-2xl md:text-4xl"
        >
          CaratLane <span className="exp-italic">Expressions</span>
        </p>
        <h2
          className="font-inter-semibold text-lg md:text-4xl max-w-[690px] leading-snug mb-3 md:mb-5 share-jewel"
        >
...
const OpenGiftIcon = () => (
  <svg className="w-12 h-12 md:w-[68px] md:h-[68px] flex-shrink-0" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const NewsletterSection = () => (
  <section className="py-6 md:py-10 px-4 md:px-10 rounded-2xl flex mt-6 md:mt-10.5" style={{ background: "linear-gradient(rgb(0, 0, 0), rgb(116, 67, 191))" }}>
    <div
      className="max-w-[1000px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-14"
    >
